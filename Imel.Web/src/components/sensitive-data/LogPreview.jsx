    ...
    <section id="logs">
      <header>
        ...
        <p className="subtitle">
          Dobrošli na prikaz svih logova sa baze podataka, pristup ovome dijelu
          aplikacije posjeduje isključivo administrator aplikacije
        </p>
        <p className="subtitle">
          Na ovom dijelu moguće je vidjeti koja osoba, sa kojom rolom(funkcijom)
          te putem koje metode i kada je manipulisala podacima baze podataka
        </p>
      </header>
      {logs.length > 0 ? (
